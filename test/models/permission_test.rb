...
class PermissionTest < ActiveSupport::TestCase
  describe "Professionals" do
    ...
    test "bloqueado" do
      ...
      assert bloqueado.allow?("devise/registrations", "create"), "Profissional(bloqueado) - devise/registrations#create - problemas na validação de permissão"
      assert bloqueado.allow?("devise/registrations", "new"), "Profissional(bloqueado) - devise/registrations#new - problemas na validação de permissão"
    ...
    test "suspenso" do
      ...
      assert suspenso.allow?("devise/registrations", "create"), "Profissional(suspenso) - devise/registrations#create - problemas na validação de permissão"
      assert suspenso.allow?("devise/registrations", "new"), "Profissional(suspenso) - devise/registrations#new - problemas na validação de permissão"
