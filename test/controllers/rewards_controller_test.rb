...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { quantidade_safiras: @reward.quantidade_safiras, service_id: @reward.service_id }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { quantidade_safiras: @reward.quantidade_safiras, service_id: @reward.service_id }
    assert_redirected_to reward_path(assigns(:reward))
  end
