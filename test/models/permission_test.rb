...
class PermissionTest < ActiveSupport::TestCase
  describe "Professionals" do
    ...
    test "deslogado" do
      ...
      assert deslogado.allow?("omniauth_callbacks", "facebook"), "Profissional(deslogado) - omniauth_callbacks#facebook - problemas na validação de permissão"
      ...
      assert deslogado.allow?("devise/professional_confirmations", "new"), "Profissional(deslogado) - devise/confirmations#new - problemas na validação de permissão"
      assert deslogado.allow?("devise/professional_confirmations", "create"), "Profissional(deslogado) - devise/confirmations#create - problemas na validação de permissão"
      assert deslogado.allow?("devise/professional_confirmations", "show"), "Profissional(deslogado) - devise/confirmations#show - problemas na validação de permissão"
      ...
      assert_not deslogado.allow?("sign_up_steps", "index"), "Profissional(deslogado) - sign_up_steps#index - problemas na validação de permissão"
      assert_not deslogado.allow?("sign_up_steps", "show"), "Profissional(deslogado) - sign_up_steps#show - problemas na validação de permissão"
      assert_not deslogado.allow?("sign_up_steps", "update"), "Profissional(deslogado) - sign_up_steps#update - problemas na validação de permissão"
    ...
    test "testando" do
      ...
      assert _testando.allow?("omniauth_callbacks", "facebook"), "Profissional(testando) - omniauth_callbacks#facebook - problemas na validação de permissão"
      ...
      assert _testando.allow?("devise/professional_confirmations", "new"), "Profissional(testando) - devise/confirmations#new - problemas na validação de permissão"
      assert _testando.allow?("devise/professional_confirmations", "create"), "Profissional(testando) - devise/confirmations#create - problemas na validação de permissão"
      assert _testando.allow?("devise/professional_confirmations", "show"), "Profissional(testando) - devise/confirmations#show - problemas na validação de permissão"
      ...
      assert _testando.allow?("sign_up_steps", "index"), "Profissional(testando) - sign_up_steps#index - problemas na validação de permissão"
      assert _testando.allow?("sign_up_steps", "show"), "Profissional(testando) - sign_up_steps#show - problemas na validação de permissão"
      assert _testando.allow?("sign_up_steps", "update"), "Profissional(testando) - sign_up_steps#update - problemas na validação de permissão"
    ...
    test "bloqueado" do
      ...
      assert bloqueado.allow?("omniauth_callbacks", "facebook"), "Profissional(bloqueado) - omniauth_callbacks#facebook - problemas na validação de permissão"
      ...
      assert bloqueado.allow?("devise/professional_confirmations", "new"), "Profissional(bloqueado) - devise/confirmations#new - problemas na validação de permissão"
      assert bloqueado.allow?("devise/professional_confirmations", "create"), "Profissional(bloqueado) - devise/confirmations#create - problemas na validação de permissão"
      assert bloqueado.allow?("devise/professional_confirmations", "show"), "Profissional(bloqueado) - devise/confirmations#show - problemas na validação de permissão"
      ...
      assert_not bloqueado.allow?("sign_up_steps", "index"), "Profissional(bloqueado) - sign_up_steps#index - problemas na validação de permissão"
      assert_not bloqueado.allow?("sign_up_steps", "show"), "Profissional(bloqueado) - sign_up_steps#show - problemas na validação de permissão"
      assert_not bloqueado.allow?("sign_up_steps", "update"), "Profissional(bloqueado) - sign_up_steps#update - problemas na validação de permissão"
    ...
    test "suspenso" do
      ...
      assert suspenso.allow?("omniauth_callbacks", "facebook"), "Profissional(suspenso) - omniauth_callbacks#facebook - problemas na validação de permissão"
      ...
      assert suspenso.allow?("devise/professional_confirmations", "new"), "Profissional(suspenso) - devise/confirmations#new - problemas na validação de permissão"
      assert suspenso.allow?("devise/professional_confirmations", "create"), "Profissional(suspenso) - devise/confirmations#create - problemas na validação de permissão"
      assert suspenso.allow?("devise/professional_confirmations", "show"), "Profissional(suspenso) - devise/confirmations#show - problemas na validação de permissão"
      ...
      assert_not suspenso.allow?("sign_up_steps", "index"), "Profissional(suspenso) - sign_up_steps#index - problemas na validação de permissão"
      assert_not suspenso.allow?("sign_up_steps", "show"), "Profissional(suspenso) - sign_up_steps#show - problemas na validação de permissão"
      assert_not suspenso.allow?("sign_up_steps", "update"), "Profissional(suspenso) - sign_up_steps#update - problemas na validação de permissão"
    ...
    test "assinante" do
      ...
      assert assinante.allow?("omniauth_callbacks", "facebook"), "Profissional(assinante) - omniauth_callbacks#facebook - problemas na validação de permissão"
      ...
      assert assinante.allow?("devise/professional_confirmations", "new"), "Profissional(assinante) - devise/confirmations#new - problemas na validação de permissão"
      assert assinante.allow?("devise/professional_confirmations", "create"), "Profissional(assinante) - devise/confirmations#create - problemas na validação de permissão"
      assert assinante.allow?("devise/professional_confirmations", "show"), "Profissional(assinante) - devise/confirmations#show - problemas na validação de permissão"
      ...
      assert assinante.allow?("sign_up_steps", "index"), "Profissional(assinante) - sign_up_steps#index - problemas na validação de permissão"
      assert assinante.allow?("sign_up_steps", "show"), "Profissional(assinante) - sign_up_steps#show - problemas na validação de permissão"
      assert assinante.allow?("sign_up_steps", "update"), "Profissional(assinante) - sign_up_steps#update - problemas na validação de permissão"
  ...
  describe "Customers" do
    ...
    test "Customer" do
      ...
      assert_not customer.allow?("sign_up_steps", "index"), "Customer - sign_up_steps#index - problemas na validação de permissão"
      assert_not customer.allow?("sign_up_steps", "show"), "Customer - sign_up_steps#show - problemas na validação de permissão"
      assert_not customer.allow?("sign_up_steps", "update"), "Customer - sign_up_steps#update - problemas na validação de permissão"
      ...
      assert customer.allow?("omniauth_callbacks", "facebook"), "Customer - omniauth_callbacks#facebook - problemas na validação de permissão"
      ...
      assert customer.allow?("devise/professional_confirmations", "new"), "Customer - devise/confirmations#new - problemas na validação de permissão"
      assert customer.allow?("devise/professional_confirmations", "create"), "Customer - devise/confirmations#create - problemas na validação de permissão"
      assert customer.allow?("devise/professional_confirmations", "show"), "Customer - devise/confirmations#show - problemas na validação de permissão"
