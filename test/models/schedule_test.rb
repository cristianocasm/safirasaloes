...
class ScheduleTest < ActiveSupport::TestCase
  ...
  describe "Cadastro" do
    test "inválido sem nome ou telefone do cliente" do
  ...
  #       assert_equal ["Informe Nome e/ou Telefone do cliente"], @sc.errors.messages[:base], "Mensagem de erro não adicionada"
  #     end
